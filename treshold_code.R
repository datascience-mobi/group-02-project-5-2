...
# schleife zum Herausfinden, wie viele Werte wir je nach Treshold verlieren und dem plotten 

tot_Unreliable <- c(1:50)
for(i in 1:50){
  treshold <- 1000000-i*5000
  Unreliable <- Coverage_hist[which(Coverage_hist > treshold)]
