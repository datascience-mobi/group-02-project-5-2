...
promoters_normalized <- read.csv(file="promoters_normalized_new.csv")
...
GOI_Feature_Selection <- read.csv(file="GOI_Feature_Selection.csv")
GOI_Feature_Selection_in_Saied <- GOI_Feature_Selection[DMR_lit_ensembl,]
...
GOI_Feature_Selection_in_Cecotka_down <- GOI_Feature_Selection[DMR_down_ensembl,]
...
GOI_Feature_Selection_in_Cecotka_up <- GOI_Feature_Selection[DMR_up_ensembl,]
...
GOI_Feature_Selection_in_Cecotka_extreme <- GOI_Feature_Selection[DMR_extreme_ensembl,]
